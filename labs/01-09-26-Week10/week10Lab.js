...
//Answer: responds to user actions (events), change css style, add new elements, delete elements, enable and disable things, change form behavior,
// change page structure, and change html attributes.
...
let myTableRow3 = document.createElement('tr');
...
myTableData3.innerHTML = 'Name';
myTableData4.innerHTML = 'Email';

myTableData5.innerHTML = 'Name';
myTableData6.innerHTML = 'Email';

myTable.append(myTableRow1)
myTable.append(myTableRow2)
myTable.append(myTableRow3)

myTableRow1.append(myTableData1);
myTableRow1.append(myTableData2);

myTableRow2.append(myTableData3);
myTableRow2.append(myTableData4);

myTableRow3.append(myTableData5);
myTableRow3.append(myTableData6);*/

//clean & readanble *best for learning) version
let myTable = document.createElement('table');
let myTableBody = document.createElement('tbody');
...
rows.forEach(rowData => {
    ...
    rowData.forEach(cellText => {
        ...
        tableData.textContent = cellText;
...
myTable.classList.add('table-style');
...
myButton.addEventListener('click', function(){
    document.body.style.backgroundColor = `rgb(${Math.random() * 225}, ${Math.random() * 255}, ${Math.random() * 255})`
});
