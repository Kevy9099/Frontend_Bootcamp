...
// console.log(alphabetString.split("",26)); //my solution
let alphabets = alphabetString.split('');
console.log(alphabets); // instructor solution 
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let abcString = alphabetArray.reverse();
console.log(abcString.join());
...
console.log("3rd element: " + array1[2]);
console.log("last element: " + array1[array1.length - 1]); // counts the array but minus 1
array1.push(16, 3);
console.log("added element: " + array1); // added 16 amd 3 at the end of the array
console.log("3rd element: " + array1[2]); // the 3rd element does not change
console.log("last element: " + array1[array1.length - 1]); // last element has change 
...
myToDoList.push("cleaning", "homework", "gaming");
console.log(myToDoList);

console.log(`-----`)
myToDoList.pop(myToDoList[2]);
console.log(myToDoList);

console.log(`-----`)
let yourTodoList = new Array();
yourTodoList.push("walk dog", "cook");
console.log(yourTodoList);

console.log(`-----`)
let ourTodoList = new Array();
