 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`On ${person.year}, ${person.firstname} ${person.lastname} was the first person to set foot on the Earth's moon.`)
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('Kevin', 'ID')
myGreeting.hello()
/*-------------------------------------------------------*/
// Question 3: myBook
console.log(`--------------------------
...
let yourBook = new Book("The Phantom Menace", "Terry Brooks");
...
class List{
    constructor(){
        this.movies = []; // empty array will store all movies here.
    }
